...
extern char* simple_itoa(int value, char* str, int base);
extern uint32_t tick;

// Fonctions utilitaires externes (depuis blackjack.c)
extern void print_at(const char* text, uint8_t color, int x, int y);
extern void show_message(const char* message, uint8_t color);
